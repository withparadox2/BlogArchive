...
<body id="media-upload" onload="body_onLoad();">
	<div  id="media-upload-header">
		<ul id="sidemenu">
			<li><span><a id="player_Tab" href="music-search.php?tab=player" <?php if ($_GET["tab"]=="player") echo 'class="current"'; ?>>插入播放器</a></span></li>
			<li><span><a id="wall_Tab" href="music-search.php?tab=wall" <?php if ($_GET["tab"]=="wall") echo 'class="current"'; ?>>插入唱片墙</a></span></li>
		</ul>
	</div>
