...
<head>
	...
	?>
	<script type="text/javascript">window.jQuery || document.write('<script type="text/javascript" src="<?php echo $tinymce_xiami_music_url; ?>inc/jquery-1.7.2.min.js"><\/script>');</script>
	<?php
		echo '<script type="text/javascript" src="'.$tinymce_xiami_music_url.'inc/tinymce_popup.js"></script>'."\n";
		echo '<link type="text/css" rel="stylesheet" href="'.$tinymce_xiami_music_url.'inc/music-search.css" />'."\n";
		echo '<script type="text/javascript" src="'.$tinymce_xiami_music_url.'inc/music-search.js"></script>'."\n";
	?>
</head>
<body id="media-upload" onload="body_onLoad();">
	<div  id="media-upload-header">
		<ul id="sidemenu">
			<li><span><a id="player_Tab" href="music-search-mce.php?tab=player" <?php if ($_GET["tab"]=="player") echo 'class="current"'; ?>>插入播放器</a></span></li>
			<li><span><a id="wall_Tab" href="music-search-mce.php?tab=wall" <?php if ($_GET["tab"]=="wall") echo 'class="current"'; ?>>插入唱片墙</a></span></li>
		</ul>
	</div>
			...
			<div id="player_Panel" class="panel">
					...
					<table class="describe"><tbody>
						<tr>
							<th valign="top" scope="row" class="label" width="245px" >
								<span class="alignleft"><label for="search_Input">输入想要搜索的歌曲名、专辑名、艺人名</label></span>
				...
				<div style="margin-top:10px;">
					...
					<span id="autoPlay">
						...
						关于自动播放： 
						<a href="http://peema.us/archives/tinymce-xiami-music.html#autoPlayNotice1" target="_blank">1</a>
						<a href="http://peema.us/archives/tinymce-xiami-music.html#autoPlayNotice2" target="_blank">2</a>
						<a href="http://peema.us/archives/tinymce-xiami-music.html#autoPlayNotice3" target="_blank">3</a>
						<a href="http://peema.us/archives/tinymce-xiami-music.html#autoPlayNotice4" target="_blank">4</a>
						<a href="http://peema.us/archives/tinymce-xiami-music.html#autoPlayNotice5" target="_blank">5</a>
						...
					</span>
				</div>
			</div>
		...
		<div class="mceActionPanel">
			...
			<div id="gAdSense">
				<script type="text/javascript"><!--
					google_ad_client = "ca-pub-5000251866162387";
					/* TinyMCE Xiami Music 搜索窗口 */
					google_ad_slot = "3186907314";
					google_ad_width = 468;
					google_ad_height = 15;
					//-->
				</script>
