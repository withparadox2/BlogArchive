...
Plugin URI: http://peema.us/archives/tinymce-xiami-music.html
...
function addXiami($atts, $content = null) {
	...
	if($id != "") return '<span class="xiami"><embed src="http://www.xiami.com/widget/470304_'.$id.'/singlePlayer.swf" type="application/x-shockwave-flash" width="257" height="33" wmode="transparent" /></span>';
	...
	if($soundfile != "") {
		...
		return '<span class="xiami"><embed src="https://dl-web.dropbox.com/u/29387701/singlePlayer.swf?soundfile='.$soundfile.'&amp;titles='.$music_info_array[0].'&amp;artists='.$music_info_array[1].'&amp;autostart='.$autostart.'&amp;loop='.$loop.'" type="application/x-shockwave-flash" width="290" height="24" wmode="transparent" /></span>';
	}
}
